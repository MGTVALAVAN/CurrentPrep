...
echo "[1/7] Updating Current Affairs page..."
...
echo "[2/7] Scraping news and generating Master Lead & Articles..."
...
echo "[3/7] Regenerating Quick Bytes with diversity-enforced prompt..."
...
echo "[4/7] Generating front page extras (Quote, On This Day, Data Snapshot)..."
...
echo "[5/7] Mocks already generated by AI pipeline..."

echo "[6/7] Running pre-send validation checklist..."
...
if [ $VALIDATION_EXIT -ne 0 ]; then
    ...
    echo "[7/7] Validation passed! Generating PDF and sending email..."
