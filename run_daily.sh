...
echo "[1/4] Scraping news and generating Master Lead & Articles..."
npx tsx generate_custom_epaper.ts

echo "[2/4] Mocks already generated by AI pipeline..."

echo "[3/4] Running pre-send validation checklist..."
...
if [ $VALIDATION_EXIT -ne 0 ]; then
    ...
    echo "[4/4] Validation passed! Generating PDF and sending email..."
